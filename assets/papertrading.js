(function () {
    ...
    function renderWatchlist() {
        ...
        SYMBOLS.forEach((s) => {
            ...
            item.className = `w-full text-left p-2 border-b border-outline-variant/10 flex items-center justify-between transition-colors hover:bg-surface-container-low dark:hover:bg-surface-container-high/40 ${
                isSelected ? 'bg-surface-container-low/80 dark:bg-surface-container border-l-4 border-l-[#e89a23] pl-2' : 'pl-2.5'
            }`;
